...
export default {
  ...
  created () {
    this.classMap = this.classMap = ['decrease', 'discount', 'special', 'invoice', 'guarantee']

    this.$http.get('https://www.easy-mock.com/mock/5aed2141efe0537f00d5c9df/api/goods').then((response) => {
